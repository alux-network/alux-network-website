# ar pending translations

Target: Arabic, polished native Arabic product/protocol copy
...
```json
{
  "home.sections.0.architecture.runtime.caption": {
    ...
    "currentStatus": "stale",
    "existingTranslation": "تجريد الآلات الافتراضية في المعمارية المستهدفة — يمثّل كل TVM تجريديًا ضمن الآلة الافتراضية العالمية الموحّدة أعلاه",
  ...
  "home.sections.0.architecture.runtime.controls.2": {
    ...
    "currentStatus": "stale",
    "existingTranslation": "إدارة الصلاحيات",
  ...
  "home.sections.0.architecture.runtime.title": {
    ...
    "currentStatus": "stale",
    "existingTranslation": "ALUX — طبقة تشغيل متزامنة لا مركزية",
  ...
  "home.sections.0.architecture.world.items.1": {
    ...
    "currentStatus": "stale",
    "existingTranslation": "تنسيق الخدمات والوكلاء",
