# ja pending translations

Target: Japanese, polished native Japanese product/protocol copy
...
```json
{
  "home.sections.0.architecture.runtime.caption": {
    ...
    "currentStatus": "stale",
    "existingTranslation": "目標アーキテクチャにおける VM 抽象化 — 各 TVM を上位の統合ワールド VM へ抽象化",
  ...
  "home.sections.0.architecture.runtime.title": {
    ...
    "currentStatus": "stale",
    "existingTranslation": "ALUX - 分散型並行ランタイム",
  ...
  "home.sections.0.architecture.world.items.1": {
    ...
    "currentStatus": "stale",
    "existingTranslation": "サービス / エージェント編成",
